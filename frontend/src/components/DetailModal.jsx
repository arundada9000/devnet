      ...
      >
        ...
        >
          ...
          <div className="p-6 overflow-y-auto space-y-5">
            {imageUrl && (
              <div
                className="relative w-full h-52 bg-gray-50 rounded-xl border border-gray-200 overflow-hidden group cursor-pointer"
                onClick={() => openPreview(imageUrl)}
              >
                <img
                  src={imageUrl}
                  alt={t("detailModal.evidence")}
          ...
          <div className="p-6 border-t border-gray-100 bg-gray-50 rounded-b-2xl flex-shrink-0 flex justify-end gap-3">
            ...
            <button
              onClick={onClose}
              className="px-6 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl font-semibold text-sm transition shadow-md"
            >
              {t("detailModal.close")}
            </button>
          </div>
