...
/**
 * Skeleton loading placeholder for the Admin Dashboard.
 * Displayed while the auth state is being verified on admin routes.
 */
  ...
  <div className="p-8 w-full min-h-screen bg-slate-50 flex flex-col gap-8 animate-pulse">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-5">
      {[1, 2, 3, 4, 5].map((i) => (
        <div
          key={i}
          className="h-36 bg-white border border-slate-100 rounded-2xl shadow-sm p-5 flex flex-col justify-between"
        >
