...
const MapSkeleton = () => {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="relative min-h-screen bg-gray-100">
      ...
      <div className="relative" style={{ height: "80vh" }}>
        ...
        {[
          ...
          { top: "60%", left: "35%" }, { top: "25%", left: "70%" }, { top: "55%", left: "80%" },
        ].map((pos, i) => (
          <motion.div key={i} className="absolute" style={{ top: pos.top, left: pos.left }}
